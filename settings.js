externaldevelop = false; //true - develop on external web server (apache); false - production on arduino web server
...
CacheCategoriesInRAM = true; //Freeing RAM after exit from category
